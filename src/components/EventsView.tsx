...
const MACRO_2026 = [
  // ── CPI (소비자물가)
  { dateKST: '2026-01-14', label: 'CPI',  desc: '12월 소비자물가 (美)',   color: '#7C6A9B' },
  { dateKST: '2026-02-13', label: 'CPI',  desc: '1월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-03-11', label: 'CPI',  desc: '2월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-04-10', label: 'CPI',  desc: '3월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-05-12', label: 'CPI',  desc: '4월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-06-10', label: 'CPI',  desc: '5월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-07-14', label: 'CPI',  desc: '6월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-08-12', label: 'CPI',  desc: '7월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-09-11', label: 'CPI',  desc: '8월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-10-13', label: 'CPI',  desc: '9월 소비자물가 (美)',    color: '#7C6A9B' },
  { dateKST: '2026-11-12', label: 'CPI',  desc: '10월 소비자물가 (美)',   color: '#7C6A9B' },
  { dateKST: '2026-12-11', label: 'CPI',  desc: '11월 소비자물가 (美)',   color: '#7C6A9B' },
  // ── NFP (비농업 고용)
  { dateKST: '2026-01-09', label: 'NFP',  desc: '12월 비농업 고용 (美)',  color: '#9C8BBD' },
  { dateKST: '2026-02-06', label: 'NFP',  desc: '1월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-03-06', label: 'NFP',  desc: '2월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-04-03', label: 'NFP',  desc: '3월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-05-08', label: 'NFP',  desc: '4월 비농업 고용 (美)',   color: '#9C8BBD' }, // 메이데이 이후 두번째 금요일
  { dateKST: '2026-06-05', label: 'NFP',  desc: '5월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-07-02', label: 'NFP',  desc: '6월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-08-07', label: 'NFP',  desc: '7월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-09-04', label: 'NFP',  desc: '8월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-10-02', label: 'NFP',  desc: '9월 비농업 고용 (美)',   color: '#9C8BBD' },
  { dateKST: '2026-11-06', label: 'NFP',  desc: '10월 비농업 고용 (美)',  color: '#9C8BBD' },
  { dateKST: '2026-12-04', label: 'NFP',  desc: '11월 비농업 고용 (美)',  color: '#9C8BBD' },
  // ── PCE (개인소비지출 물가)
  { dateKST: '2026-01-30', label: 'PCE',  desc: '12월 PCE 물가 (美)',     color: '#7C6A9B' },
  { dateKST: '2026-02-27', label: 'PCE',  desc: '1월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-03-27', label: 'PCE',  desc: '2월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-04-30', label: 'PCE',  desc: '3월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-05-29', label: 'PCE',  desc: '4월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-06-26', label: 'PCE',  desc: '5월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-07-31', label: 'PCE',  desc: '6월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-08-28', label: 'PCE',  desc: '7월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-09-25', label: 'PCE',  desc: '8월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-10-30', label: 'PCE',  desc: '9월 PCE 물가 (美)',      color: '#7C6A9B' },
  { dateKST: '2026-11-25', label: 'PCE',  desc: '10월 PCE 물가 (美)',     color: '#7C6A9B' },
  { dateKST: '2026-12-23', label: 'PCE',  desc: '11월 PCE 물가 (美)',     color: '#7C6A9B' }, // 크리스마스 전날
  // ── GDP (분기 속보치)
  { dateKST: '2026-01-29', label: 'GDP',  desc: 'Q4 2025 GDP 속보 (美)',  color: '#4F7E7C' },
  { dateKST: '2026-04-29', label: 'GDP',  desc: 'Q1 2026 GDP 속보 (美)',  color: '#4F7E7C' },
  { dateKST: '2026-07-30', label: 'GDP',  desc: 'Q2 2026 GDP 속보 (美)',  color: '#4F7E7C' },
  { dateKST: '2026-10-29', label: 'GDP',  desc: 'Q3 2026 GDP 속보 (美)',  color: '#4F7E7C' },
];
...
export default function EventsView({ T }: { T?: any }) {
  ...
  const SECTOR_COLOR: Record<string, string> = {
    Tech: '#9C8BBD', Finance: '#C89650', Healthcare: '#7BAF7A',
    Consumer: '#D4956A', Energy: '#C4A84F', Industrial: '#6B6B6B',
    Telecom: '#9B7FD4', Utility: '#4F7E7C', Material: '#B07A5A',
  ...
  const MACRO_CATEGORIES: { key: string; label: string; color: string; labels: string[] }[] = [
    ...
    { key: 'PRICE',   label: '물가',    color: '#7C6A9B', labels: ['CPI', 'Core CPI', 'PPI', 'Core PPI', 'PCE', 'Core PCE'] },
    { key: 'EMPLOY',  label: '고용',    color: '#9C8BBD', labels: ['NFP', 'ADP', '실업청구', '실업률'] },
    { key: 'GROWTH',  label: '성장',    color: '#4F7E7C', labels: ['GDP', 'GDP 속보', 'GDP속보', '산업생산', '내구재'] },
    ...
    { key: 'K200',    label: 'K200',    color: '#6B6B6B', labels: ['K200만기'] },
  ];
  ...
  return (
    <div>
      ...
      <div className="mb-6 border-y" style={{ borderColor: theme.border }}>
        <div className="flex items-center justify-between gap-3 py-2 border-b mono text-[14px] uppercase tracking-[0.2em]"
        ...
        <div className="grid grid-cols-4 gap-2 md:gap-6 py-2 mono text-[14px] uppercase tracking-[0.2em]">
          ...
          <div className="flex items-baseline gap-1 md:gap-2">
            ...
            <span style={{ color: loading ? theme.textDimmer : '#9C8BBD' }}>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="w-full min-w-0 border" style={{ borderColor: theme.border }}>
          ...
          <div className="flex items-center justify-between px-4 md:px-6 py-3 border-b"
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              ...
              <button onClick={goToday}
                className="text-[14px] mono uppercase tracking-[0.2em] px-2 py-0.5 border hover:opacity-70 transition-opacity"
                style={{ borderColor: theme.border, color: theme.textFaint }}>
                오늘
              </button>
              {/* 인덱스 필터 */}
              <div className="flex border" style={{ borderColor: theme.border }}>
                {([
                  ...
                  <button key={key} onClick={() => setIndexFilter(key)}
                    className="text-[15px] mono px-2 py-0.5 transition-colors"
                    style={{
          ...
          <div className="border-b" style={{ borderColor: theme.border, background: theme.bgCard }}>
            ...
            <div className="px-3 pt-2 pb-1 flex flex-wrap items-center gap-1.5">
              ...
              <button
                ...
                className="text-[15px] mono px-2 py-0.5 border transition-all"
                style={{
                  borderColor: showMacro ? '#4F7E7C' : theme.borderSoft,
                  background: showMacro ? '#5FA8A020' : 'transparent',
                  color: showMacro ? '#4F7E7C' : theme.textDimmer,
                }}>
                지표
              </button>
          ...
          <div className="grid grid-cols-7 border-b" style={{ borderColor: theme.border }}>
            {DAY_LABELS.map((d, i) => (
              <div key={d} className="text-center py-2 text-[14px] mono uppercase tracking-[0.15em]"
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    {evs.length > 2 && (
                      <div className="text-[14px] mono px-1 md:hidden" style={{ color: theme.textDimmer }}>+{evs.length - 2}개</div>
                    )}
                    {evs.length > 4 && (
                      <div className="text-[15px] mono px-1 hidden md:block" style={{ color: theme.textDimmer }}>+{evs.length - 4}개</div>
                    )}
                  </div>
                </div>
              );
          ...
          <div className="flex items-center gap-4 px-4 md:px-6 py-3 border-t flex-wrap"
            ...
            {[
              ...
              { color: '#7C6A9B', label: 'CPI' },
              { color: '#9C8BBD', label: 'NFP' },
              { color: '#7C6A9B', label: 'PCE' },
              { color: '#4F7E7C', label: 'GDP' },
              { color: '#7BAF7A', label: 'Healthcare' },
              { color: '#C89650', label: 'Finance' },
              { color: '#6B6B6B', label: 'K200만기' },
            ].map(({ color, label }) => (
              <div key={label} className="flex items-center gap-1.5">
                <span className="w-2.5 h-2.5 rounded-sm"
                  style={{ background: `${color}${isLight ? '55' : '33'}`, borderLeft: `2px solid ${color}` }} />
                <span className="text-[14px] mono" style={{ color: theme.textDimmer }}>{label}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-5 w-full">
          ...
          {selectedDate && (
            <div className="border" style={{ borderColor: theme.border }}>
              <div className="px-4 py-3 border-b flex items-center justify-between"
                style={{ borderColor: theme.border, background: theme.bgCard }}>
                <span className="text-[15px] mono uppercase tracking-[0.2em]" style={{ color: theme.textMuted }}>
                  {parseInt(selectedDate.slice(5, 7))}월 {parseInt(selectedDate.slice(8, 10))}일
                </span>
                {selectedDate === today && (
                  <span className="text-[15px] mono px-1.5 py-0.5 border"
              ...
              {selectedEvents.length === 0 ? (
                <div className="px-4 py-6 text-center text-[15px]" style={{ color: theme.textDimmer }}>이벤트 없음</div>
              ) : (
                <div>
                    ...
                    return (
                      <div key={i}>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {e && (
                                <div className="flex gap-1 flex-wrap">
                                  ...
                                  {e.isNDX100 && (
                                    <span className="text-[15px] mono px-1 border"
                                      style={{ color: '#9C8BBD', borderColor: '#7B9FDF50' }}>NDX</span>
                                  )}
                                </div>
                              )}
                            </div>
                          ...
                          <div className="text-[15px] mt-0.5" style={{ color: theme.textMuted }}>{ev.desc}</div>
                        </div>
                          ...
                          <div className="px-4 py-3 border-b"
                            ...
                            <div className="grid grid-cols-3 gap-3">
                              {[
                                ...
                                <div key={label}>
                                  <div className="text-[15px] mono uppercase tracking-[0.15em] mb-1" style={{ color: theme.textDimmer }}>{label}</div>
                        ...
                        {isExpanded && e && (
                          <div className="px-4 py-3 border-b"
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              {/* EPS */}
                              <div>
                                <div className="text-[15px] mono uppercase tracking-[0.15em] mb-1.5"
                                ...
                                <div className="flex items-baseline gap-2 flex-wrap">
                                  <span className="text-sm font-semibold"
                                    ...
                                    {e.epsActual == null && e.epsEstimate != null && (
                                      <span className="text-[15px] ml-1" style={{ color: theme.textDimmer }}>(예상)</span>
                                    )}
                                  </span>
                                  {e.epsEstimate != null && e.epsActual != null && (
                                    <span className="text-[14px]" style={{ color: theme.textFaint }}>
                              ...
                              <div>
                                ...
                                {e.surprise != null ? (
                                  ...
                                  <span className="text-[15px]" style={{ color: theme.textDimmer }}>-</span>
                                )}
                              </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                        ...
                        {e?.isNDX100 && (
                          <span className="text-[14px] mono px-1 border"
                            style={{ color: '#9C8BBD', borderColor: '#7B9FDF40' }}>NDX</span>
                        )}
                        {/* EPS 예상 */}
                        {e?.epsEstimate != null && (
                          <span className="text-[15px] mono ml-auto shrink-0"
          ...
          <p className="text-[15px] mono text-center mt-1 md:col-span-2" style={{ color: theme.textDimmer }}>
