...
export const metadata: Metadata = {
  title: '패치노트 · StockWiKi.kr',
  description: 'StockWiKi 업데이트 패치노트 — 새로운 기능과 개선사항을 확인하세요.',
};
    ...
    <div style={{
      ...
      <style>{`
        @media (max-width: 600px) {
          .pn-title { font-size: 28px !important; }
          .pn-body  { padding: 40px 16px 80px !important; }
          .pn-entry { padding-bottom: 40px !important; }
          .pn-ver   { font-size: 15px !important; }
          .pn-item  { font-size: 12px !important; }
        }
      `}</style>
      ...
      {/* 본문 */}
      <div className="pn-body" style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 120px' }}>

        {/* 타이틀 */}
        <div style={{ marginBottom: 64 }}>
          <div style={{
            fontSize: 10, letterSpacing: '0.26em', color: '#C89650',
            marginBottom: 16, fontFamily: 'var(--font-mono), monospace',
          }}>
            PATCH NOTES
          </div>
          <h1 className="pn-title" style={{
            fontSize: 'clamp(28px, 5vw, 48px)', fontWeight: 200,
            letterSpacing: '-0.03em', margin: 0, lineHeight: 1.2,
          }}>
            패치노트
          </h1>
          <p style={{ color: '#76726e', fontSize: 14, marginTop: 12, lineHeight: 1.7 }}>
            StockWiKi의 새로운 기능과 개선사항을 투명하게 공개합니다.
          </p>
        </div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          {CHANGELOG.map((entry, idx) => {
            ...
            return (
              <div key={entry.version} className="pn-entry" style={{
                paddingLeft: 28,
                paddingBottom: 56,
                position: 'relative',
              }}>
                ...
                <div style={{
                  ...
                  gap: 10, marginBottom: 10, flexWrap: 'wrap' as const,
                }}>
                  <span className="pn-ver" style={{
                ...
                <ul style={{
                  ...
                  {entry.itemsPublic.map((item, i) => (
                    <li key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                      ...
                      <span className="pn-item" style={{ fontSize: 13, color: '#a8a49a', lineHeight: 1.7 }}>{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
