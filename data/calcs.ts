...
export const CALC_CATEGORIES: CalcCategory[] = [
  ...
  },
  {
    ...
    calcs: [
      { id: 'futures', name: '선물 손익', num: '22' },
      { id: 'leverage', name: '레버리지 · 증거금', num: '23' },
      { id: 'bs', name: '블랙-숄즈 옵션가', num: '24' },
  ...
  },
  {
    ...
    calcs: [
      { id: 'fx', name: '환차손익', num: '32' },
      { id: 'realrate', name: '실질금리', num: '33' },
      { id: 'bondprice', name: '채권 가격', num: '34' },
    ],
  },
  {
    name: '포트폴리오', color: '#6B9B6B',
    calcs: [
      { id: 'sectorweight', name: '섹터별 비중', num: '35' },
      { id: 'fxhedge', name: '환헷지 비율', num: '36' },
      { id: 'rebalance', name: '리밸런싱', num: '37' },
    ],
  },
  {
    name: '세금 · 절세', color: '#5B8DB8',
    calcs: [
      { id: 'capitalgain', name: '양도소득세', num: '38' },
      { id: 'healthinsurance', name: '건강보험료 (금융소득)', num: '39' },
      { id: 'incometax', name: '종합소득세 간이', num: '40' },
      { id: 'gifttax', name: '증여세', num: '41' },
      { id: 'pension', name: '연금 수령액', num: '42' },
